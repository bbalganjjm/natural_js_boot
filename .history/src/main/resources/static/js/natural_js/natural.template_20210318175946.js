                        ...
                        textfield : function(cont) { // textarea, input
                            N('.mdc-text-field', cont.view).each(function(i, el) {
                                ...
                                if(el.is("textarea")) {
                                    ...
                                    var btnId = "";
                                    if(el.data("btnid")) {
                                        btnId = ' id="' + el.data("btnid") + '"';
                                    }
                                    if(el.data("trailingicon")) {
                                        mdcTextField.addClass("mdc-text-field--with-trailing-icon");
                                        el.after('<i' + btnId + ' class="material-icons mdc-text-field__icon mdc-text-field__icon--leading" tabindex="0" role="button">' + el.data("trailingicon") + '</i>');
                                    }
                                    if(el.data("leadingicon")) {
                                        mdcTextField.addClass("mdc-text-field--with-leading-icon");
                                        el.before('<i' + btnId + ' class="material-icons mdc-text-field__icon mdc-text-field__icon--trailing" tabindex="0" role="button">' + el.data("leadingicon") + '</i>');
                                    }
                                }
