                            ...
                            N('.mdc-text-field', cont.view).each(function(i, el) {
                                ...
                                if(el.is("textarea")) {
                                    ...
                                    if(el.data("trailingicon")) {
                                        ...
                                        el.after('<i class="material-icons mdc-text-field__icon mdc-text-field__icon--leading" tabindex="0" role="button">' + el.data("trailingicon") + '</i>');
                                    }
                                    if(el.data("leadingicon")) {
                                        mdcTextField.addClass("mdc-text-field--with-leading-icon");
                                        el.before('<i class="material-icons mdc-text-field__icon mdc-text-field__icon--trailing" tabindex="0" role="button">' + el.data("leadingicon") + '</i>');
                                    }
                                }
