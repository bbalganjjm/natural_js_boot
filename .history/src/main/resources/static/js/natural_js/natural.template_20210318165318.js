                            ...
                            N('.mdc-text-field', cont.view).each(function(i, el) {
                                ...
                                if(el.is("textarea")) {
                                    ...
                                    if(el.data("trailingicon")) {
                                        el.addClass("mdc-text-field--with-trailing-icon");
                                        mdcTextField.prepend('<i aria-hidden="true" class="material-icons mdc-text-field__icon">' + el.data("trailingicon") + '</i>');
                                    }
                                    if(el.data(el.data("leading")) {
                                        el.addClass("mdc-text-field--with-leading-icon");
                                        mdcTextField.prepend('<i aria-hidden="true" class="material-icons mdc-text-field__icon">' + el.data("leading") + '</i>');
                                    }
                                }
