Natural-JS Boot
===
Natural-JS Boot는 [Natural-JS](https://bbalganjjm.github.io/natural_js)(Natural-TEMPLATE)와 Spring Boot로 구성된 MSA(Micro Service Architecture) 기반 기업용 웹 어플리케이션 개발을 위한 최고의 Start-Up 키트입니다.
