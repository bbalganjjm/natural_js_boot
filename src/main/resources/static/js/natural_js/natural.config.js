                    ...
                    success : function(request, data, textStatus, xhr) {
                        ...
                        if((opts.target && N.isElement(opts.target)) || opts.dataType === "html" || opts.contentType === "text/css") {
                            if(location.hostname === "localhost" || location.hostname === "127.0.0.1") {
                                ...
                                data = N.code.addSourceURL(data, opts.url.replace(".html", ".js").replace(".view", ".js"));
                            }
        ...
        "docs" : {
            ...
            "message" : {
                "ko_KR" : {
                    ...
                    "closeAllDQ" : "열려있는 메뉴 전체를 닫고 메인(홈) 화면으로 이동 하시겠습니까?",
                    ...
                    "maxStateful" : "선택한 메뉴가 활성화되면 설정된 최대 상태 유지 메뉴 개수(최대 {1} 개)가 초과되어 마지막으로 선택된 \"{0}\" 메뉴 페이지가 다시 로딩됩니다.<br>메뉴를 선택 하시겠습니까?"
                },
                "en_US" : {
